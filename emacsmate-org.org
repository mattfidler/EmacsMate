...
| diary.org  | Journal                     |
| weekly.org | Weekly Review               |
| daily.org  | Daily Review                |
|------------+-----------------------------|
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (define-key ergoemacs-keymap (kbd "C-c a") 'org-agenda)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (emacsmate-m "Org Remove Context")
#+end_src
