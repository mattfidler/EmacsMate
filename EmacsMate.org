...
#+BEGIN_SRC emacs-lisp
  ...
  (when (emacsmate-packge-load-path 'ergoemacs-keybindings)
    ...
    (when (string= ergoemacs-keyboard-layout "colemak")
      (define-key ergoemacs-keymap "\M-o" 'isearch-forward-regexp)
      (define-key ergoemacs-keymap "\M-O" 'isearch-backward-regexp))
...
*** Org-mode
This is taken from
https://raw.github.com/eschulte/emacs24-starter-kit/master/starter-kit-org.org
...
** Yasnippet bug fix
The current version of Yasnippet is broken.  
