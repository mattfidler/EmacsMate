...
#+BEGIN_SRC emacs-lisp
  ;; Mode line setup
  (when (emacsmate-packge-load-path 'powerline)
    (require 'powerline)
    ...
    (set-face-attribute 'mode-line-position-per-face nil
       ...
       (:eval
        (let* ((active (eq (frame-selected-window) (selected-window)))
               ...
               (lhs (list
                     ...
                     (powerline-arrow-right (cond
                                             ...
                                             ((condition-case err
                                                ...
                                                (error nil))
                                              'mode-line-modified-face)
                                             (t nil)) 'mode-line-project-face)
                     ;;(powerline-buffer-size nil 'l)
                     (powerline-raw (concat (car (funcall tabbar-buffer-groups-function)) " ") 'mode-line-project-face 'l)
                     
                     (powerline-arrow-right 'mode-line-project-face 'mode-line-filename-face)
                     
                     (powerline-buffer-id 'mode-line-filename-face 'l)
                     (powerline-raw " " 'mode-line-filename-face)
                     (powerline-arrow-right  'mode-line-filename-face nil)
                     
                     (powerline-major-mode 'mode-line-face 'l)
                     (powerline-raw " [" 'mode-line-minor-mode-face)
                     (powerline-minor-modes 'mode-line-minor-mode-face nil)
                     (powerline-raw "] " 'mode-line-minor-mode-face)
                     (powerline-raw mode-line-process 'mode-line-minor-mode-face 'l)
                     
                     (powerline-narrow 'mode-line-face 'l)
               ...
               (rhs (list
                     ...
                     (powerline-raw "%4l" 'mode-line-position-face  'r)
                     (powerline-raw ":" 'mode-line-position-face)
                     (powerline-raw "%3c" (if (>= (current-column) 80)
                                              'mode-line-80col-face
                                            'mode-line-position-face) 'r)
