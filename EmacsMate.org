...
#+BEGIN_SRC emacs-lisp
  ...
  (when (emacsmate-packge-load-path 'ergoemacs-mode)
    ...
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '(forward-char next-history-element minor-mode-overriding-map-alist))
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '(backward-char previous-history-element minor-mode-overriding-map-alist))
    ...
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '("<right>" next-history-element minor-mode-overriding-map-alist))
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '("<left>" previous-history-element minor-mode-overriding-map-alist))
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '("<up>" ido-prev-match minor-mode-overriding-map-alist))
    (ergoemacs-minor-key 'ido-minibuffer-setup-hook '("<down>" ido-next-match minor-mode-overriding-map-alist))
    ...
    (ergoemacs-key "M-*" 'mc/mark-next-like-this)
    (ergoemacs-key "M-n" 'mc/edit-lines)
